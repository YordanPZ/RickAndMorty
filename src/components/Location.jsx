...
function Location({ Locations, selectedLocation }) {
    ...
    return (
        <div >
            <h2 className="font-bold text-5xl text-center mb-6 text-white tex tracking-widest">{locationToShow.name}</h2>
            <div className="dimension flex flex-col gap-4 text-white container-fluid justify-around ml-2 mr-2 rounded-full p-4">
                <div className="flex gap-9 text-xl justify-around items-center">
